...
**Source:** `waylay.services.resources.models.resource_type_entity`
...
resource_type_entity = ResourceTypeEntity(
    provider=...,
    provider_id=...,
    customer=...,
    firmware=...,
...
# Create from JSON
resource_type_entity = ResourceTypeEntity.from_json(
    '{ "provider": ..., "providerId": ..., "customer": ..., "firmware": ..., "location": ..., "metrics": ..., "sensors": ..., "id": ..., "name": ..., "icon": ..., "templates": ... }'
)

# Export to dictionary
resource_type_entity_dict = resource_type_entity.to_dict()
```
