...
class ChangedEventStub:
    ...
    def create_json(cls):
        ...
        return changed_event_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "ChangedEvent":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                ChangedEventAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return ChangedEventAdapter.validate_python(
