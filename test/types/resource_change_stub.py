...
class ResourceChangeStub:
    ...
    def create_json(cls):
        ...
        return resource_change_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "ResourceChange":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                ResourceChangeAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return ResourceChangeAdapter.validate_python(
