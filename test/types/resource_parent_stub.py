...
class ResourceParentStub:
    ...
    def create_json(cls):
        ...
        return resource_parent_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "ResourceParent":
        ...
        if not json:
            ...
            backup_faker = JSF(
                ResourceParentAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return ResourceParentAdapter.validate_python(
