...
class SSEventStreamStub:
    ...
    def create_json(cls):
        ...
        return ss_event_stream_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "SSEventStream":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                SSEventStreamAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return SSEventStreamAdapter.validate_python(
