...
from ..models.hal_resource_entity_all_of_links import HALResourceEntityAllOfLinks
...
class HALResourceEntity(BaseModel):
    """HAL Representation of a Waylay _Resource_."""

    links: HALResourceEntityAllOfLinks = Field(alias="_links")
    id: ResourceId
    ...
    def to_dict(self) -> dict[str, Any]:
        """Convert the HALResourceEntity instance to dict."""
        return self.model_dump(by_alias=True, exclude_unset=True, exclude_none=True)

    def to_json(self) -> str:
        """Convert the HALResourceEntity instance to a JSON-encoded string."""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create a HALResourceEntity instance from a dict."""
        return cls.model_validate(obj)

    @classmethod
    def from_json(cls, json_data: str | bytes | bytearray) -> Self:
        """Create a HALResourceEntity instance from a JSON-encoded string."""
