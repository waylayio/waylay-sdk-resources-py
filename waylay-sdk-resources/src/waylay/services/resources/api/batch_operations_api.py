...
if TYPE_CHECKING:
    ...
    from waylay.services.resources.queries.batch_operations_api import (
        GetQuery,
        StartQuery,
    )
    ...
    async def start(
        ...
        **kwargs,
        ...
        if json is not None and validate_request:
            _BodyType = Annotated[BatchResourceOperation, Field(description="Resource Batch Operation")]  # fmt: skip  # noqa: UP045
