...
class ResourceTypeApi(WithApiClient):
    ...
    async def create(
        ...
        **kwargs,
        ...
        if json is not None and validate_request:
            _BodyType = ResourceTypeWithConstraints  # fmt: skip  # noqa: UP045
    ...
    async def list_changes(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> builtins.list[ResourceTypeChange]: ...
    ...
    async def list_changes(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> builtins.list[ResourceTypeChange] | T | Response | Model:
    ...
    async def patch(
        ...
        **kwargs,
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = PatchResourceTypeEntity  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
